...
namespace YoungsBanks.Requests
{
    ...
    public class DepositAccountRequestValidator : AbstractValidator<DepositAccountRequest>
    {
        public DepositAccountRequestValidator(IAccountRepository<Account> accountRepo)
        {
